 ...
 <div class="card">
    <div class="row g-0">
      <div class="col-md-4 border-end">
        <img src="https://file3.qdnd.vn/data/images/0/2017/09/11/hoangha/110917hha01.jpg" class="img-fluid" alt="...">
      </div>
      <div class="col-md-8">
        <div class="card-body">
          ...
          <div class="row row-cols-auto row-cols-1 row-cols-md-3 align-items-center">
            <div class="col">
                ...
                <div class="input-group input-spinner">
                    <button class="btn btn-outline-danger" type="button" id="button-plus"> + </button>
                     <input type="text" class="form-control" value="1">
                    <button class="btn btn-outline-danger" type="button" id="button-minus"> − </button>
                </div>
            </div> 
            <div class="col">
                    ...
                    <div class="">
                        ...
                        <label class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" name="select_size" checked="">
                            <div class="form-check-label">M</div>
                          </label>

                          <label class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" name="select_size" checked="">
                            <div class="form-check-label">L</div>
                          </label>
                    </div>
            </div> 
            <div class="col">
                ...
                <div class="">
                        <label class="form-check form-check-inline">
                          <input type="radio" class="form-check-input" name="select_size" checked="">
                          <div class="form-check-label">Đỏ</div>
                        </label>
                        <label class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" name="select_size" checked="">
                            <div class="form-check-label">Trắng</div>
                          </label>

                          <label class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" name="select_size" checked="">
                            <div class="form-check-label">Đen</div>
                          </label>
                    </div>
            </div>
        </div>
        <div class="d-flex gap-3 mt-3">
            ...
            <a href="#" class="btn btn-outline-danger"><span class="text">Thêm Vào Giỏ Hàng</span> <i class="bx bxs-cart-alt"></i></a>
        </div>
        </div>
      </div>
    </div>
