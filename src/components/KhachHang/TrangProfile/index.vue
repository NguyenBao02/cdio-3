        ...
        <ul class="nav nav-tabs nav-dark" role="tablist">
          ...
          <li class="nav-item nav-dark" role="presentation">
            ...
            >
              <div class="d-flex align-items-center">
                <div class="tab-icon">
                  <i class="fa-solid fa-address-book font-18 me-1"></i>
                </div>
                    ...
                    <div class="col-2 text-end">
                      <div class="row mb-2 mt-3">
                        <button
                          ...
                          v-on:click="Object.assign(dia_chi_delete, value)"
                        >
                          Xoá
                        </button>
                      </div>
                      <div class="row">
                        <button
                          ...
                          v-on:click="Object.assign(dia_chi_update, value)"
                        >
                          Cập Nhật
                        </button>
                      </div>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <b class="text-danger">
                      ...
                      <b>{{ dia_chi_delete.dia_chi }}</b> không?</b
                    >
                  </div>
                  ...
                  <div class="modal-body">
                    <div class="row">
                      <div class="col-6">
                        ...
                        <input
                          v-model="dia_chi_update.ten_nguoi_nhan"
                          type="text"
                      ...
                      <div class="col-6">
                        ...
                        <input
                          v-model="dia_chi_update.so_dien_thoai"
                          type="text"
                          class="form-control mt-2 mb-2"
                    ...
                    <div class="col-12">
                      ...
                      <input
                        v-model="dia_chi_update.dia_chi"
                        type="text"
                        class="form-control"
                  ...
                  <div class="modal-body">
                    <div class="row">
                      <div class="col-6">
                        ...
                        <input
                          v-model="dia_chi_create.ten_nguoi_nhan"
                          type="text"
                          class="form-control"
                      ...
                      <div class="col-6">
                        ...
                        <input
                          v-model="dia_chi_create.so_dien_thoai"
                          type="text"
                          class="form-control"
                    ...
                    <input
                      v-model="dia_chi_create.dia_chi"
                      type="text"
                      class="form-control"
...
export default {
  ...
  methods: {
    ...
    updateProfile() {
      axios
        .post(
          "http://127.0.0.1:8000/api/khach-hang/update-thong-tin",
          this.profile,
          {
            headers: {
              Authorization: "Bearer " + localStorage.getItem("key_login"),
    ...
    updateMatKhau() {
      axios
        .post(
          "http://127.0.0.1:8000/api/khach-hang/update-mat-khau",
    ...
    createDiaChi() {
      axios
        .post(
          "http://127.0.0.1:8000/api/khach-hang/dia-chi/create",
          this.dia_chi_create,
          {
            headers: {
              Authorization: "Bearer " + localStorage.getItem("key_login"),
    ...
    updateDiaChi() {
      axios
        .post(
          "http://127.0.0.1:8000/api/khach-hang/dia-chi/update",
          this.dia_chi_update,
          {
            headers: {
              Authorization: "Bearer " + localStorage.getItem("key_login"),
    ...
    deleteDiaChi() {
      axios
        .post(
          "http://127.0.0.1:8000/api/khach-hang/dia-chi/delete",
          this.dia_chi_delete,
          {
            headers: {
              Authorization: "Bearer " + localStorage.getItem("key_login"),
